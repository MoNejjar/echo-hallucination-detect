    ...
    <TooltipProvider>
      <div className="w-28 bg-gradient-to-b from-white via-gray-50/50 to-white dark:from-gray-900 dark:via-gray-950/50 dark:to-gray-900 border-r border-gray-200/60 dark:border-gray-800/60 flex flex-col shadow-xl backdrop-blur-sm">
        ...
        <div className="flex-1 p-3 space-y-2">
          ...
          <div className="mt-auto pt-4 border-t border-gray-200/30 dark:border-gray-800/30">
            <Dialog>
              <Tooltip>
                <TooltipTrigger asChild>
          ...
          {!feedbackSubmitted ? (
            <div className="space-y-4">
              ...
              <div className="text-center">
                <p className="text-sm text-gray-600 dark:text-gray-400 mb-2">How would you rate your experience?</p>
                    ...
                    <button
                      ...
                      className={`w-8 h-8 rounded-full transition-all duration-200 ${
                        value <= rating 
                          ...
                          : 'bg-gray-200 dark:bg-gray-700 text-gray-400 hover:bg-yellow-200 dark:hover:bg-yellow-700'
                      }`}
                    >
